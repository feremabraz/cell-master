...
describe('Travel Exploration', () => {
  ...
  describe('initializeExplorationState', () => {
    ...
    it('should calculate daily movement rate based on terrain', () => {
      ...
      const difficultState = initializeExplorationState(character, 'Wilderness', 'Difficult', 'Bright');
      const veryDifficultState = initializeExplorationState(character, 'Wilderness', 'Very Difficult', 'Bright');
  ...
  describe('moveCharacter', () => {
    ...
    it('should adjust movement by terrain difficulty', () => {
      ...
      const difficultState = initializeExplorationState(character, 'Dungeon', 'Difficult', 'Bright');
