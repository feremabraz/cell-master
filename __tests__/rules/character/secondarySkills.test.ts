...
describe('Secondary Skills', () => {
  ...
  describe('checkSecondarySkill', () => {
    ...
    it('should handle different skill levels correctly', () => {
      ...
      expect(checkSecondarySkill({ skill: 'Blacksmith', level: SkillLevel.Apprentice }, 5)).toBe(false);
      
      // Journeyman: 80% - (5 * 5%) = 55% chance
      expect(checkSecondarySkill({ skill: 'Blacksmith', level: SkillLevel.Journeyman }, 5)).toBe(false);
