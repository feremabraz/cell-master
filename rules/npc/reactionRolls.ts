...
export function getCharismaReactionModifier(character: Character): ReactionModifier {
  ...
  // Based on OSRIC charisma reaction modifiers
  ...
  if (charisma <= 8) return { value: -5, source: 'Charisma' };
  if (charisma <= 12) return { value: 0, source: 'Charisma' };
  if (charisma <= 14) return { value: 5, source: 'Charisma' };
  if (charisma <= 15) return { value: 10, source: 'Charisma' };
  if (charisma <= 16) return { value: 15, source: 'Charisma' };
  if (charisma <= 17) return { value: 20, source: 'Charisma' };
  if (charisma <= 18) return { value: 25, source: 'Charisma' };
  return { value: 30, source: 'Charisma' }; // For rare cases above 18
}
