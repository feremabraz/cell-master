...
export const getAlignmentDetails = (alignment: Alignment): AlignmentDetails => {
  const alignmentDetails: Record<Alignment, AlignmentDetails> = {
    ...
    'Lawful Neutral': {
      name: 'Lawful Neutral',
      description: 'A lawful neutral character acts as law, tradition, or a personal code directs them. Order and organization are paramount. They may believe in personal order and live by a code or standard, or might believe in order for all, favoring a strong, organized government.',
      nicknames: ['Judge'],
    ...
    'Lawful Evil': {
      name: 'Lawful Evil',
      description: 'A lawful evil villain methodically takes what they want within the limits of their code of conduct without regard for whom it hurts. They care about tradition, loyalty, and order but not about freedom, dignity, or life. They play by the rules but without mercy or compassion.',
      nicknames: ['Dominator'],
    ...
    'Neutral Good': {
      name: 'Neutral Good',
      description: 'A neutral good character does the best that a good person can do. They are devoted to helping others. They work with kings and magistrates but do not feel beholden to them if they feel that their superiors are not serving the cause of good.',
    ...
    'True Neutral': {
      name: 'True Neutral',
      description: 'A neutral character has no strong allegiance to either good vs. evil or law vs. chaos. Most neutral characters exhibit a lack of conviction or bias rather than a commitment to neutrality. They see good as preferable to evil but may not act to uphold it without direct self-interest.',
      nicknames: ['Undecided', 'Balanced'],
      compatibleAlignments: ['Lawful Neutral', 'Neutral Good', 'True Neutral', 'Neutral Evil', 'Chaotic Neutral'],
      naturalEnemies: []
    },
    'Neutral Evil': {
      name: 'Neutral Evil',
      description: 'A neutral evil villain does whatever they can get away with. They are out for themselves, pure and simple. They shed no tears for those they kill, whether for profit, sport, or convenience. They have no love of order and hold no illusion that following laws would make them any better or more noble.',
    ...
    'Chaotic Good': {
      name: 'Chaotic Good',
      description: 'A chaotic good character acts as their conscience directs, with little regard for what others expect. They make their own way, but they are generally kind and benevolent. They believe in goodness and personal honor, but have little use for laws and regulations.',
      nicknames: ['Rebel'],
    ...
    'Chaotic Neutral': {
      ...
      description: 'A chaotic neutral character follows their whims. They are an individualist first and last. They value their own liberty but do not strive to protect others\' freedom. They avoid authority, resent restrictions, and challenge traditions.',
 ...
 */
export const isAlignmentCompatibleWithClass = (alignment: Alignment, characterClass: string): boolean => {
 ...
 */
export const getAlignmentReactionModifier = (alignment1: Alignment, alignment2: Alignment): number => {
  if (alignment1 === alignment2) {
