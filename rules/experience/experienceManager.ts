...
import type { ExperienceTracker, XPSource, XPHistoryEntry } from './types';
...
/**
 * Jotai atoms for experience management
 */
export const experienceTrackerAtom = atom<ExperienceTracker | null>(null);

export const experienceProgressAtom = atom((get) => {
  const tracker = get(experienceTrackerAtom);
